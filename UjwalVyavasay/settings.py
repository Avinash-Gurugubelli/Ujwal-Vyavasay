"""
Django settings for UjwalVyavasay project.
...
SECRET_KEY = 'django-insecure-nb#x66_ul!e&$^qdio6t1ux-$=z^ruk)q89-^xb*+$^_ixo7qe'
...
ROOT_URLCONF = 'UjwalVyavasay.urls'
...
WSGI_APPLICATION = 'UjwalVyavasay.wsgi.application'
...
MEDIA_URL='/media/'
MEDIA_ROOT = os.path.join(BASE_DIR,'media/shop/uploads')
